internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        students[0] = new("Худов", "К.А.", "20ИТ11", new int[] { 2, 2, 2, 2, 2 });
        students[1] = new("Турлин", "Р.Ф.", "22ИТ21", new int[] { 3, 3, 3, 3, 3 });
        students[2] = new("Авдеев", "Н.Т.", "21ИТ35", new int[] { 5, 5, 5, 5, 5 });
        students[3] = new("Рубашенко", "Р.К.", "22ИТ35", new int[] { 4, 4, 4, 4, 4 });
        students[4] = new("Федоров", "П.М.", "22ИТ35", new int[] { 2, 4, 4, 5, 4 });
        students[5] = new("Разумовская", "К.С.", "23ИТ12", new int[] { 3, 3, 4, 5, 2 });
        students[6] = new("Еналеева", "О.И.", "21ИТ18", new int[] { 2, 5, 5, 5, 4 });
